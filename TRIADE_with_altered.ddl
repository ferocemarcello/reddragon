...
create table PIZZO_SALDO_PIZZI_MENSILE (
	 ...
	 anno int(4) not null,
	 cod_triade int(4) not null,
     constraint IDPIZZO_SALDO_PIZZI_MENSILE primary key (importo, attivita_commerciale, mese, anno, cod_triade));
...
alter table PIZZO_SALDO_PIZZI_MENSILE add constraint FKPIZZ_SAL_PIZ_MENS_SALDO_PIZZI_MENSILE
...
alter table PROSTITUTA add constraint FKPROSTITUZ_PROSTITUTA
